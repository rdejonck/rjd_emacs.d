...
;;;;; display-fill-column-indicator
   `(fill-column-indicator ((,class :foreground ,zenburn-blue-3 :weight semilight)))
;;;;; eww
...
;;;;; adoc-mode
   ;; I want to use zenburn-height-plus-X like in the org-mode section, but
   ;; I get errors saying that it does not evaluate to a positive integer
   ;; So, just hardcoding the sizes from adoc-mode

   ;; adoc base faces
   `(adoc-fixed-face (( (:inherit font-lock-constant-face))))
   `(adoc-gen-face ((t (:foreground ,zenburn-cyan))))
   `(adoc-meta-face ((t (:foreground ,zenburn-yellow))))
   `(adoc-markup-face ((t (:foreground ,zenburn-fg+1))))
   
   `(adoc-anchor-face ((t (:inherit adoc-meta-face
                                    :foreground ,zenburn-blue+1
                                    :overline t))))
   `(adoc-code-face ((t (:inherit adoc-fixed-face))))
   `(adoc-command-face ((t (:inherit adoc-meta-face :weight bold
                                     :box(:line-width 2 :style released-button
                                                      :color ,zenburn-yellow)
                                     :foreground ,zenburn-yellow
                                     :background ,zenburn-bg+2))))
   `(adoc-emphasis-face ((t (:inherit adoc-gen-face :slant italic))))
   `(adoc-internal-reference-face ((t (:inherit adoc-meta-face
                                                :foreground ,zenburn-yellow-2
                                                :underline t))))
   `(adoc-list-face ((t (:inherit adoc-markup-face :foreground ,zenburn-fg+1))))
   `(adoc-meta-hide-face ((t (:inherit adoc-meta-face :foreground ,zenburn-bg+3))))
   `(adoc-secondary-text-face ((t (:foreground ,zenburn-yellow-1 :height 0.9))))
   `(adoc-title-face ((t (:inherit ,z-variable-pitch :weight bold
                                   :foreground ,zenburn-cyan))))
   `(adoc-title-0-face ((t (:inherit adoc-title-face :foreground ,zenburn-blue
                                     ,@(when zenburn-scale-org-headlines
                                         (list :height 2.0))))))
   `(adoc-title-1-face ((t (:inherit adoc-title-face :foreground ,zenburn-orange
                                     ,@(when zenburn-scale-org-headlines
                                         (list :height 1.8))))))
   `(adoc-title-2-face ((t (:inherit adoc-title-face :foreground ,zenburn-green+4
                                     ,@(when zenburn-scale-org-headlines
                                        (list :height 1.6))))))
   `(adoc-title-3-face ((t (:inherit adoc-title-face :foreground ,zenburn-blue-1
                                     ,@(when zenburn-scale-org-headlines
                                        (list :height 1.4))))))
   `(adoc-title-4-face ((t (:inherit adoc-title-face :foreground ,zenburn-yellow-2
                                     ,@(when zenburn-scale-org-headlines
                                         (list :height 1.2))))))
   `(adoc-title-5-face ((t (:inherit adoc-title-face :foreground ,zenburn-cyan
                                     ,@(when zenburn-scale-org-headlines
                                         (list :height 1.0))))))
   
   `(adoc-typewriter-face ((t (:inherit adoc-fixed-face :foreground ,zenburn-green))))
   `(adoc-verbatim-face ((t (:inherit adoc-fixed-face :background ,zenburn-bg+1
                                      :box (:line-width 2 :color ,zenburn-bg+1)))))
   `(adoc-value-face ((t (:inherit adoc-meta-face))))
;;;;; android mode
